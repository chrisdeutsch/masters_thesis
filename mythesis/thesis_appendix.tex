...
\begin{minipage}{\textwidth}
  ...
  \end{subfigure}
  \caption[Migration matrix of the extended model requiring consistency with the
  number of reconstructed tracks]{Migration matrix for the extended model
    including conversion, shot and additional cluster information. The model is
    constrained by setting estimated mode probabilities to zero for modes not
    consistent with the number of reconstructed tracks.}
\end{minipage}
