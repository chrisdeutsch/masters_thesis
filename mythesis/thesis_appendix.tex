...
\begin{table}[htbp]
  ...
  \caption{Signal samples ($\gamma^* \to \tauhad\tauhad$) used for BDT- and
    RNN-based Tau Identification}
...
\begin{table}[htbp]
  ...
  \caption{Background samples (dijet) used for BDT- and RNN-based Tau
    Identification}
...
\begin{table}[htbp]
  ...
  \caption{Signal samples ($Z / \gamma^* \to \tau\tau$) for the Phase-II upgrade
    of the ATLAS detector with the Extended ITk-layout.}
...
\begin{table}[htbp]
  ...
  \caption{Background samples (dijet) for the Phase-II upgrade of the ATLAS
...
\begin{table}[htbp]
  ...
  \caption{Samples used for the RNN-based Decay Mode Classification.}
