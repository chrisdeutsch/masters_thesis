...
three-dimensional clusters of calorimeter cells called TopoClusters. The
...
energy~\cite{atlas_topoclustering}. To seed a \tauhadvis candidate the jet has
...
identification. This is because isolation variables employing the
\emph{isolation} category were found to be underperforming. The \emph{modified
