...
\begin{figure}[htb]
  ...
  \caption{Efficiency and purity profiles of the decay mode classification using
    the extended model as a function of reconstructed visible
    momentum~$p_\text{T}$ of the tau decay. Evaluated on the testing sample.
...
This is likely due to difficulties in classfying events containing
...
hadronic tau decays. \todo{This is actually done in COMBINED \& MVA TES}
