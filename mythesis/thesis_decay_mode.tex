...
or at least one neutral pion $3h^\pm \geq 1\pi^0$ shall be discriminated. These
five decay modes make up the majority of hadronic tau-lepton decays (approx.
\SI{92}{\percent}). $h^\pm$ includes charged pions as well as kaons.
\todo{Intermediate neutral kaons are omitted} Neural networks naturally extend
from binary to multi-class classification problems making them well-suited for
the discrimination of the hadronic decay modes.
...
\item[Number of shots $N_\text{shots}$:] Number of shots (cmp.\ section
  ...
  contributes with the largest weight. \todo{Recover merged $\pi^0$ if more than
    2 shots. Very important \SI{1.5}{\percent} diag.\ eff.}
\end{description}
