...
\begin{table}[htb]
  ...
  \todo[inline]{Errors not negligible. Is this validation or testing set?}
\end{table}
...
pions \todo{Check migration matrix}. The purity \todo{Continue}. The plots in
Figure~\ref{fig:mode_efficiency_purity} indicate that the the RNN-based
classification algorithm could be used beyond the design limit of \SI{100}{\GeV}
...
\todo[inline]{Improvements for energy calibration}
