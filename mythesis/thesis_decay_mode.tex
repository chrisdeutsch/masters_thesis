...
\begin{table}[htb]
  ...
  \begin{tabular}{p{4.5cm}p{9cm}}
    ...
    Second moment of the radial distance $R$ between cluster cells and shower \\
    ...
    \textbf{Fraction of subtracted transverse momentum} $f_\text{sub}$ &
    Fraction of total cluster energy subtracted during reconstruction of the
    particle flow object\\
    \bottomrule
  \end{tabular}
  }
  \caption{Cluster variables}
...
A summary of all experiments is given in Table~\ref{tab:pfo_add_experiments}.
Tested bidirectional LSTMs for neutral PFOs -- marginal improvement
\SI{0.2}{\percent} to \SI{0.3}{\percent}.
