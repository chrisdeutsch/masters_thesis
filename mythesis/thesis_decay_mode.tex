...
decay modes make up the majority of hadronic tau-lepton decays \todo{Continue
  (numbers). Kaons are rare. Including charged pions but neglecting neutral
  pions}. Neural networks naturally extend from binary to multi-class
...
\begin{table}[htb]
  ...
  \todo[inline]{Mistake in BDT sorting - redo}
\end{table}
