...
efficiency tends to be a stable metric between different trainings and is used
as a figure of merit for subsequent investigations.

\todo[inline]{Discuss the migration matrix: ATLAS vs RNN}
...
\begin{figure}[htb]
  ...
  \caption{Migration matrices with normalised columns showing the migration of
    the true decay modes to the reconstructed modes. Statistical fluctuations
    due to limited sample size can be neglected.}
