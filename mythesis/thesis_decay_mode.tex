...
Often photons from the \smash{$\pi^0$}-decay convert into electron-positron
pairs in material of the inner detector. The magnetic field bends the pair from
the direction of the initiating photon, spreading out the energy deposition in
the EM calorimeter. This can lead to neutral PFOs being reconstructed from
