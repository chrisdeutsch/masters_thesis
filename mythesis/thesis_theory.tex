...
The electromagnetic and weak interactions are unified in the electro-weak theory
...
symmetry of the electro-weak theory when introducing a mass term into the
...
Lagrangian introducing four degrees of freedom. Three are absorbed into the
$W^+$, $W^-$ and $Z^0$ bosons giving them masses. The remaining neutral and
scalar component becomes the physical Higgs boson.

Coupling to massive particles.

The Higgs mechanism is also used to generate masses of the fermions, however
...
Large number of parameters 26 (if counting the CP violating strong phase which
is measured to be small)~\cite{thomson}
