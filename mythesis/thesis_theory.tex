...
The discriminating variable used in the~$H \to \tau\tau$
analysis~\cite{higgs_tautau}, separating the signal from the
...
algorithms could lead to a significant improvement of the signal significance in
this measurement.
