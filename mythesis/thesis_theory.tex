...
\begin{figure}[htb]
  ...
  \end{subfigure}
  \caption[Decay and branching ratios of the tau lepton]{Decay and branching ratios of the tau lepton. Charge-conjugate decay
    modes are omitted.}
\end{figure}
...
\begin{figure}[htb]
  ...
  \end{subfigure}
  \caption[Hadronic tau lepton decays in collider experiments at the
  LHC]{Examples for the use of hadronic tau lepton decays in collider
