...
properties with the exception of an increasing particle mass with each
...
right-handed particles, although with different strength. The weak interaction
is observed to violate \cp symmetry in the quark
sector~\cite{cp_violation_quark_sector, cp_violation_quark_sector_2}, while \cp
violation in the lepton sector is not yet confirmed.
...
\begin{figure}[htb]
  \begin{subfigure}[b]{0.47\textwidth}
    ...
    \vspace*{3em} \subcaption{Feynman diagram of the tau decay. The $d^\prime$
      is the weak eigenstate mixing the mass eigenstates of the $d$- and
      $s$-quark.}
...
against electrons and muons. However, compared to \tauhad from quark- and
gluon-jets, this plays a secondary role in the identification and is not
considered here.
...
\item[Isolation] The secondary particles produced in a hadronic tau decay form a
  ...
  quarks and gluons is on average broader than in hadronic tau decays. As a
...
significant background of~\tauhad originating from quark- and gluon-jets is
present. As the expected signal contribution of the Higgs boson is smaller than
the background from fake \tauhad, an improvement in the tau identification
...
identified. Nevertheless, one of the major backgrounds in this analysis
are~$\tauhad$ originating from quark- and gluon-initiated jets in multijet
