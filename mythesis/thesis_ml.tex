...
decays with each time step such that it is not possible to learn long-term
dependencies in the input sequence \cite{hochreiter, lecun_bengio_hinton_DL}.
The following section will present an extension to this architecture enabling
...
introducing gates that control the flow of information in a recurrent cell.
