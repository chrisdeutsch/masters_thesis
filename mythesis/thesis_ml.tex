...
network, an output layer with activation~$\mathbf{y}$ \todo{define} and
...
\begin{figure}[htb]
  ...
  \begin{minipage}[t]{0.55\textwidth}
    ...
    \captionof{figure}{Multi-layer perceptron with input neurons $\mathbf{x}$,
      ...
      activation function $\bm{\varphi}$. Block matrix notation is used.}
    \label{fig:multi_layer_perceptron}
    \todo[inline]{Slim down caption}
  \end{minipage}\hfill
...
\end{align*}
is chosen as the activation function, \todo{split sentence}
