...
\begin{figure}[ht]
  ...
  \caption{Rejection as a function of the hyperparameters. Uses
    \SI{50}{\percent} subsampling. (1-prong). \todo{KS-Probability as comparison}}
...
\begin{figure}[ht]
  ...
  \caption{Rejection as a function of the hyperparameters. Not using
    subsampling. (3-prong). \todo{Not as prone to overfitting? Why? This shows
      ...
      higher 3-prong stats for background.} \todo{Move bottom two plots to
      appendix.}}
...
\begin{figure}[ht]
  ...
  \end{subfigure}
  \caption{\emph{ROC}-Curves. \todo{Rule of thumb? For 10 percent signal
...
\begin{figure}[ht]
  ...
  \end{subfigure}
  \caption{Working points (BDT A) \todo{Larger pt range in appendix}.
    \todo{Ratio is bootstrapped due to highly correlated errors}}
\end{figure}
...
\todo{SumPtTrkFrac for 3-prong BDT}

\subsection{Variable Importance}
\label{sec:bdt_var_importance}

\todo{Recursive Feature Elimination}

\todo{Input variable correlations}

\todo{Bar chart for dropped variables}
