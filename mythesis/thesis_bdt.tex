...
reconstruction framework uses BDTs trained with TMVA~\cite{tmva}. The maximum
depth of individual decision trees is limited to~$d_\text{tree} = 8$ and the
minimum fraction of events contained in a node considered for further splitting
