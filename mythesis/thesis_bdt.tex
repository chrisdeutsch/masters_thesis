...
Will optimise the hyperparameters of the identification algorithm (i.e.\
parameters that are not learned during training). Look at boosting algorithm
then optimise parameters using a grid search.

The input variables are transformed -- log, clamping where needed (this is a
technical detail). Highly skewed and long-tailed distributions.

Brief explanation of hyperparameters and their interconnection.
