...
the purposes of this study a fixed cut on the identification score \todo{plot
  with cut?} is used to identify di-tau events.
...
di-tau trigger with offline \tauhadvis \pt-threshold on the leading and
...
threshold for the di-tau identification. The decision threshold could be
