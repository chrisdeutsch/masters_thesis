...
optimised BDT from Chapter~\ref{sec:bdt}. The models required little
hyperparameter optimisation to reach the given performances. This indicates that
neural networks might be advantageous for the current tau identification method,
offering a viable alternative to BDTs.
