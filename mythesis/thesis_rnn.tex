...
\begin{figure}[htb]
  ...
  a ditau trigger at the HL-LHC]{Performance of the TopoCluster-based ditau
    identification for use in a ditau trigger at the HL-LHC.}
...
\begin{figure}[htb]
  ...
  \caption[Network architecture of the model combining high-level identification
