...
will focus on describing the method using tracks in the inner detector but using
different physics objects is analogous.

each track has associated variables: track transverse momentum angular distances (specifics later)
can also have global variables not associated with a specific track (e.g.\ tau variables)
...
In Figure~\ref{fig:track_rnn_schematic} the architecture used in this chapter.
